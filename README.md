...
> 📊 **完整流程圖**（每階段用幾個 skill / agent、在處理什麼、機制、策略 + mermaid 全貌）見 **[`plugins/loops-workflow/docs/FLOW.md`](plugins/loops-workflow/docs/FLOW.md)**。下面是快速參考。
...
└── references/   各階段規範 + 模板（clean-code / clean-architecture / code-simplification /
