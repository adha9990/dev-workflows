...
| | |
|---|---|
| **skill** | 12（dispatch / **clarify** 釐清模糊需求 / define / goal / explore / plan / build / verify / iterate / explain / **scaffold-fullstack** 內建 greenfield 骨架 / **decision-interview** 四象限 Unknowns Register，由 clarify·define·plan 依風險內部調用） |
