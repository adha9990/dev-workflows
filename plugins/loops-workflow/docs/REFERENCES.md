...
| `verify-triage` | verify 改動風險 4 級梯判準（SKIP/LIGHT/STANDARD/DEEP）：高風險硬閘清單 / SKIP·LIGHT 護欄 / tangling veto / 「做錯東西就整個退回」catastrophic-miss 判準（所有級、審查後 triage） | verify（§1.4 判級） |
