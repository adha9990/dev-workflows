...
//     LOOPS_PR_EFFORT_GATE / LOOPS_PR_CONFLICT_GATE / LOOPS_MERGE_GUARD / LOOPS_PR_OWNER_GUARD）：
...
const DEFAULT_ON_FLAGS = [
  ...
  // #222：閘⑨ 投入檔位低於自己的地板（宣稱 direct、實際碰高風險硬閘）。同上，被 A1 反向完整性
  // 斷言接住——新 flag 一加進 FLAG_DEFAULTS 就紅，不是等某天有人發現它沒被測到。
  'LOOPS_PR_EFFORT_GATE',
