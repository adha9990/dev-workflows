...
- **「便宜但留債」的選項必須把債標明在代價面**（留下什麼風險、何時會爆——例：保留新舊雙路徑、暫留 shim、退回本該完成的遷移）；**不得預設標 `(Recommended)`（除非使用者已明示接受該債）**——推薦以長期正確性與風險消除為先，「代價小」只在同等正確的選項間當 tie-breaker（AGENTS 規則 10）。若所有可行選項都留債，推薦**長期最接近正確、債最明確可控**的那個，並在每個選項明標各自的債。auto 模式自動採推薦選項——這條在 auto 下就是拍板本身。
