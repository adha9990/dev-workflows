...
console.log('  pnpm -r typecheck && pnpm -r lint && pnpm -r test');
console.log('  cd backend && cp dev.json.example dev.json && pnpm dev   # API 在 :51599');
console.log('  pnpm --filter frontend dev                               # Vite 在 :5173');
